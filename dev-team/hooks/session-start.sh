...
# Agents: backend-engineer-php, database-engineer, devops-engineer,
#         frontend-bff-engineer-typescript, frontend-designer, ui-engineer,
#         qa-analyst, qa-analyst-frontend, sre, frontend-engineer-vuejs,
#         ui-engineer-vuejs, qa-analyst-frontend-vuejs, frontend-engineer-react-native,
#         ui-engineer-react-native, qa-analyst-frontend-react-native
...
| Via \`bee-dev-team:dev-cycle\` | Optional | N/A |
| Via \`bee-dev-team:dev-refactor\` | **MANDATORY** | Prompt contains \`**MODE: ANALYSIS ONLY**\` |

**When MANDATORY (bee-dev-team:dev-refactor invocation):**
1. Agent receives prompt with \`**MODE: ANALYSIS ONLY**\`
2. Agent MUST load Bee standards via WebFetch
...
For full details: Skill tool with \"bee-dev-team:using-dev-team\"
</bee-dev-team-system>"
