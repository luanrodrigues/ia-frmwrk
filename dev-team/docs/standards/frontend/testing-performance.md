...
import { Button, Input } from '@luanrodrigues/sindarian-ui';

// FORBIDDEN: Wildcard import (imports everything)
import * as SindarianUI from '@luanrodrigues/sindarian-ui';

// FORBIDDEN: Default import of entire library
import SindarianUI from '@luanrodrigues/sindarian-ui';
```
