...
|------|-----------|------------|
| **sindarian-ui** (primary) | `@luanrodrigues/sindarian-ui` in package.json | FormField, FormItem, FormLabel, FormControl, FormMessage, FormTooltip |
...
import {
    ...
    FormTooltip,
    Input,
} from '@luanrodrigues/sindarian-ui';
