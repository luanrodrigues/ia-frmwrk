...
|------|-----------|------------|
| **sindarian-vue** (primary) | `@luanrodrigues/sindarian-vue` in package.json | FormField, FormItem, FormLabel, FormControl, FormMessage, FormTooltip |
...
import {
    ...
    FormTooltip,
    Input,
} from '@luanrodrigues/sindarian-vue'
