...
sequence:
  ...
  before: [bee:dev-bee:sre]

related:
  complementary: [bee:dev-implementation, bee:dev-unit-testing]
...
3. Identify services needed:
   ...
   - From language (PHP → php:8.3-fpm-alpine base, TS → node base)
...
<dispatch_required agent="bee:devops-engineer">
...
Task:
  ...
  prompt: |
    ...
    ## Standards Reference
    WebFetch: https://raw.githubusercontent.com/luanrodrigues/ia-frmwrk/master/dev-team/docs/standards/devops.md
...
|-----------|---------------|
| "Skip Docker, runs fine locally" | "Docker ensures consistency. Dispatching bee:devops-engineer now." |
