...
Canonical validation rules for custom instructions in bee:dev-cycle and bee:dev-refactor skills.
...
| Gate 4 (Review) | MUST dispatch all 6 reviewers |
...
- **Stored:** `custom_prompt` field in `docs/bee:dev-cycle/current-cycle.json`
