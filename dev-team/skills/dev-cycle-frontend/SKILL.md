...
Parse the JSON content:
  - If "dependencies" or "devDependencies" contains "@luanrodrigues/sindarian-ui"
...
**`@luanrodrigues/sindarian-ui`** is PRIMARY. shadcn/ui + Radix is FALLBACK for missing components.
