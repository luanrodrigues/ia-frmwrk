...
Recommendations:
→ Skill bee:dev-unit-testing: Add test planning phase
...
```
Use Skill tool: bee:dev-feedback-loop
```

The skill contains the complete workflow with:
- Metrics collection from bee:dev-cycle
- Pattern analysis
