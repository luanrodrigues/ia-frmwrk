# Bee Plugin Marketplace Installer (PowerShell)
...
Write-Host "================================================"
Write-Host "Bee Plugin Marketplace Installer"
Write-Host "================================================"
Write-Host ""

$MARKETPLACE_SOURCE = "luanrodrigues/bee"
$MARKETPLACE_NAME = "bee"
...
Write-Host "📦 Adding Bee marketplace from GitHub..."
try {
...
if ($marketplaceOutput -match "already installed") {
    ...
    Write-Host "❌ Failed to add Bee marketplace"
    Write-Host $marketplaceOutput
    exit 1
} else {
    Write-Host "✅ Bee marketplace added successfully"
}
Write-Host ""
...
Write-Host "  3. Try: /bee-default:brainstorm or Skill tool: 'bee-default:using-bee'"
Write-Host ""
