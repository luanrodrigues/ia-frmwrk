...
echo "Select platforms to install Bee:"
echo ""
...
echo ""
echo "Commands:"
echo "  ./installer/install-bee.sh                    # Interactive install"
echo "  ./installer/install-bee.sh --platforms claude # Direct install"
echo "  ./installer/install-bee.sh update             # Update installation"
echo "  ./installer/install-bee.sh list               # List installed"
echo ""
