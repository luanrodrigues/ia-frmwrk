"""Platform adapters for Bee installer.

This module provides adapters for transforming Bee components to various
AI platform formats.

Supported Platforms:
- Claude Code: Native Bee format (passthrough)
- Codex: Native Bee format (passthrough)
...
from bee_installer.adapters.claude import ClaudeAdapter
from bee_installer.adapters.cline import ClineAdapter
from bee_installer.adapters.cursor import CursorAdapter
from bee_installer.adapters.factory import FactoryAdapter
from bee_installer.adapters.opencode import OpenCodeAdapter
...
class CodexAdapter(ClaudeAdapter):
    ...
    Codex uses the Bee/Claude Code format with a different install root:
