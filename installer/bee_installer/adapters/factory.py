"""
Factory AI adapter - converts Bee format to Factory's droid-based format.

Factory AI uses similar concepts to Bee but with different terminology:
- agents -> droids
- skills -> skills (same)
...
class FactoryAdapter(PlatformAdapter):
    ...
    def transform_skill(self, skill_content: str, metadata: Optional[Dict[str, Any]] = None) -> str:
        """
        Transform a Bee skill for Factory AI.
    ...
    def transform_agent(self, agent_content: str, metadata: Optional[Dict[str, Any]] = None) -> str:
        """
        Transform a Bee agent to a Factory AI droid.
    ...
    def transform_command(self, command_content: str, metadata: Optional[Dict[str, Any]] = None) -> str:
        """
        Transform a Bee command for Factory AI.
    ...
    def transform_hook(self, hook_content: str, metadata: Optional[Dict[str, Any]] = None) -> Optional[str]:
        """
        Transform a Bee hook for Factory AI.
    ...
    def get_component_mapping(self) -> Dict[str, Dict[str, str]]:
        ...
        Returns:
            Mapping of Bee components to Factory AI directories
        """
        return {
            "agents": {
                "target_dir": "droids",
    ...
    def get_terminology(self) -> Dict[str, str]:
        ...
        Returns:
            Mapping of Bee terms to Factory AI terms
        """
        return {
            "agent": "droid",
            "skill": "skill",
    ...
    def _replace_agent_references(self, text: str) -> str:
        ...
        result = masked
        for pattern, replacement in bee_contexts:
