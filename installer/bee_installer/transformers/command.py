...
Transforms Bee slash command files to platform-specific formats.
"""
...
class CommandTransformer(BaseTransformer):
    """
    Transformer for Bee command files.
    ...
    def _transform_cursor(
        ...
        transformed_body = transformed_body.replace("/bee:", "/")
    ...
    def _transform_cline(
        ...
        parts.append("## Steps")
        parts.append("")
        # Command transformer needs to replace /bee: with @ for Cline
