...
Generates .cursorrules files from Bee skills and components.
"""
...
class CursorRulesGenerator(BaseTransformer):
    ...
    Creates consolidated rules files from multiple Bee skills,
    ...
    def generate(self, include_metadata: bool = True) -> str:
        ...
        parts.append("")
        parts.append("These rules are generated from Bee skills.")
    ...
    def _transform_content(self, content: str) -> str:
        ...
        # Use base class method with additional bee: prefix removal
        result = self.transform_body_for_cursor(content)
        result = result.replace("bee:", "")  # Remove bee: prefix
        return result
