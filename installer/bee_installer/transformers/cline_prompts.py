...
Generates companion prompts for Cline from Bee skills and agents.
"""
...
class ClinePromptsGenerator(BaseTransformer):
    ...
    Creates prompt templates from Bee skills, agents, and commands
    ...
    def generate_index(self) -> str:
        ...
        lines = [
            ...
            "",
            "This directory contains Bee skills, agents, and commands",
...
class ClinePromptsTransformer(BaseTransformer):
    """
    Transformer that generates Cline prompts from Bee components.
...
def generate_cline_prompt(
    ...
    """
    Generate a single Cline prompt from a Bee component.
...
def write_cline_prompts(
    ...
    """
    Write Cline prompt files from Bee components.
