...
**If feature is simple (<2 days, existing patterns), use `/bee:pre-dev-feature` instead.**
...
2. Run AI-assisted time estimation:
   - Auto-detect tech stack from Dependency Map (if available) OR repository files (package.json, composer.json, etc.)
...
3. Use /bee:worktree to create isolated workspace
4. Use /bee:write-plan to create implementation plan
