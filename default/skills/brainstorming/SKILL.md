...
skip_when: |
  - Design already complete and validated → use bee:writing-plans
  - Have detailed plan ready to execute → use bee:executing-plans
  - Just need task breakdown from existing design → use bee:writing-plans

sequence:
  before: [bee:writing-plans, bee:using-git-worktrees]

related:
  similar: [bee:writing-plans]
---
...
**Announce at start:** "I'm using the bee:brainstorming skill to refine your idea into a design."
...
| **5. Worktree Setup** | Set up isolated workspace | bee:using-git-worktrees skill | Ready development environment |
| **6. Planning Handoff** | Create implementation plan | bee:writing-plans skill | Detailed task breakdown |
...
- Announce: "I'm using the bee:using-git-worktrees skill to set up an isolated workspace."
- **REQUIRED SUB-SKILL:** Use bee:using-git-worktrees
...
- Announce: "I'm using the bee:writing-plans skill to create the implementation plan."
- **REQUIRED SUB-SKILL:** Use bee:writing-plans
...
- CANNOT skip sub-skill usage (bee:writing-plans, bee:using-git-worktrees) when applicable
