...
**Current limitation:** Test agents running in Midaz repo can't access skill in `../bee/` directory.
...
2. **Add to bee:using-bee** - Document this skill in the ring skill catalog
