...
### Code Quality (bee:code-reviewer)
| Severity | Examples |
|----------|----------|
...
### Business Logic (bee:business-logic-reviewer)
| Severity | Examples |
|----------|----------|
...
### Security (bee:security-reviewer)
| Severity | Examples |
|----------|----------|
...
### Test Quality (bee:test-reviewer)
| Severity | Examples |
|----------|----------|
...
### Nil Safety (bee:nil-safety-reviewer)
| Severity | Examples |
|----------|----------|
