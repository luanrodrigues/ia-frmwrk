...
1. **Create Failing Test** - Simplest reproduction. **Use bee:test-driven-development skill.**
...
- **bee:test-driven-development** - For failing test case (Phase 4, Step 1)
