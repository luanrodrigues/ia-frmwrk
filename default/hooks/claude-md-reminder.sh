...
agent_reminder="${agent_reminder}| Code review | bee:code-reviewer + bee:business-logic-reviewer + bee:security-reviewer (PARALLEL) |\n"
agent_reminder="${agent_reminder}| Implementation plan | bee:write-plan |\n"
agent_reminder="${agent_reminder}| Deep architecture | bee:codebase-explorer |\n\n"
