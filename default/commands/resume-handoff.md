...
# /bee:resume-handoff Command

Resumes work from a previously created handoff document.

> **Note:** If you just ran `/bee:create-handoff` followed by `/clear`, the handoff is **automatically loaded** - you don't need this command. Use this command to manually resume from **older handoffs** or **specific handoff files**.

## Usage

```
/bee:resume-handoff <path-to-handoff.md>
```
...
```
# Previous session
User: /bee:create-handoff auth-refactor "OAuth integration"
...
User: /bee:resume-handoff docs/handoffs/auth-refactor/2025-12-27_15-45-00_session.md
...
| Invalid format | Not a handoff file | Ensure file was created with /bee:create-handoff |
...
- **Auto-resume works automatically**: After `/bee:create-handoff` + `/clear`, the handoff loads automatically within 1 hour. Beyond 1 hour, you'll be prompted. Use this command only for older or specific handoffs.
