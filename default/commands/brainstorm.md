...
- Design is already complete and validated - use `/bee:write-plan`
- Have a detailed plan ready to execute - use `/bee:execute-plan`
- Just need task breakdown from existing design - use `/bee:write-plan`
