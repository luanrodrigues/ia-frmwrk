...
**Position:** Parallel reviewer (runs simultaneously with bee:code-reviewer, bee:business-logic-reviewer, bee:test-reviewer, bee:nil-safety-reviewer, bee:consequences-reviewer)
