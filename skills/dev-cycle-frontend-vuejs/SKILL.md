...
Parse the JSON content:
  - If "dependencies" or "devDependencies" contains "@lerianstudio/sindarian-vue"
...
**`@lerianstudio/sindarian-vue`** is PRIMARY. shadcn-vue + Radix Vue is FALLBACK for missing components.
