...
| Common Hallucination | Action |
|---------------------|--------|
| gRPC requirement | Verify in php.md "Frameworks & Libraries" section |
| GraphQL requirement | Verify in php.md "Frameworks & Libraries" section |
| Symfony instead of Laravel | Check actual framework in php.md |
| Doctrine instead of Eloquent | Check actual ORM in php.md |
