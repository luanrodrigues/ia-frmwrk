...
import { Button, Input } from '@lerianstudio/sindarian-vue'

// FORBIDDEN: Wildcard import (imports everything)
import * as SindarianVue from '@lerianstudio/sindarian-vue'

// FORBIDDEN: Default import of entire library
import SindarianVue from '@lerianstudio/sindarian-vue'
```
