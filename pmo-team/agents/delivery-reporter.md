...
input_schema:
  required_context:
    ...
    - name: "visual_identity"
      type: "string"
      description: "Visual identity option (lerian/bee/custom)"
  optional_context:
...
- Visual identity not specified (user didn't choose lerian/bee/custom)
...
- [ ] Visual identity selected (lerian/bee/custom)
